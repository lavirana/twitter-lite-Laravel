...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="<?php echo e(asset('admin/js/jquery.mousewheel.js')); ?>"></script>
<script src="<?php echo e(asset('admin/js/raphael.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/js/jquery.mapael.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/js/usa_states.min.js')); ?>"></script>
<!-- ChartJS -->
...
<?php /**PATH C:\xampp\htdocs\tweety\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>