              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody id="messages">
                    ...
                    <tr>
                      <td><?php echo e($happ->id); ?></td>
                      <td><?php echo e($happ->title); ?></td>
                      <td><?php echo e($happ->description); ?></td>
                      <td><span class="tag tag-success"><?php echo e(date("Y-m-d",strtotime($happ->created_at))); ?></span></td>
