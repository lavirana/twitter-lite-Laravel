...
<div class="lg:flex lg:justify-center">
  ...
  height: 500px;" >
    ...
    height: 330px;">
           ...
           <a href="javascript:void(0);"  data_id="<?php echo e($user->id); ?>" class="get_id"> <li style="margin-bottom: 17px;
    border-bottom: 1px solid rgb(0, 0, 0);
    padding: 12px 9px 16px 8px;">
                            
   <?php if($user->avatar == "http://127.0.0.1:8000/storage" || empty($user->avatar)): ?>
    
    <img style="    width: 31px;
    float: right;" src=http://127.0.0.1:8000/images/twitter.png class="rounded-full mr-2">
     <?php else: ?>
               <img style="width: 31px;
    float: right;" src="http://127.0.0.1:8000/storage/<?php echo e($user->avatar); ?>">
             
    <?php endif; ?>  
               <?php echo e($user->username); ?></li> </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tweety\resources\views/messages.blade.php ENDPATH**/ ?>