        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-12">
              ...
              <div class="card-header">
                ...
                <form method="post" action="<?php echo e(action('admin\HomeController@getSearchusers')); ?>">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody id="messages">
                    ...
                    <tr id="myTableRow<?php echo $user->id; ?>">
                      ...
                      <td><?php echo e(ucfirst($user->username)); ?></td>
                      <td><?php echo e($user->name); ?></td>
                      <td>
                        <?php if($user->avatar == 'http://127.0.0.1:8000/storage' || $user->avatar == ""): ?>
                          <img src="http://127.0.0.1:8000/storage/avatars/twitter.png" width="40" class="rounded-full mr-2">
                        <?php else: ?>
                          <img src="http://127.0.0.1:8000/storage/<?php echo e($user->avatar); ?>" width="40" class="rounded-full mr-2">
                        <?php endif; ?>
                        </td>
                        
                      <td>
                       <?php if($user->cover_image == 'http://127.0.0.1:8000/storage' || $user->cover_image == ""): ?>   
                    <img src="http://127.0.0.1:8000/storage/avatars/twitter.png" width="40" class="rounded-full mr-2">    
                          <?php else: ?>
                    <img src="http://127.0.0.1:8000/storage/<?php echo e($user->cover_image); ?>" width="40" class="rounded-full mr-2">
                          <?php endif; ?>
                          
                        </td>
                      <td><?php echo e($user->email); ?></td>
                      <td><span class="tag tag-success"><?php echo e(date("Y-m-d",strtotime($user->created_at))); ?></span></td>
<td>
    <!--<button type="button" class="btn btn-block btn-warning btn-xs"  data-toggle="modal" data-target="#myModal">Edit</button>-->
                        ...
                        <button class="btn btn-block btn-danger btn-xs dllee" data-attr="<?php echo e($user->id); ?>">Delete</button>
...
<?php echo $__env->make('admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tweety\resources\views//admin/users.blade.php ENDPATH**/ ?>