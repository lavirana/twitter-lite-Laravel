  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Contact us Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title">Contact us Detail</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody id="messages">
                    ...
                    <tr id="myTableRow<?php echo $contact->id; ?>">
                      ...
                      <td><span class="tag tag-success">{{ date("Y-m-d",strtotime($contact->added_on)) }}</span></td>
<td>
...
@endsection
  ...
  <div class="modal fade" id="myModal<?php echo $count; ?>" role="dialog" style="display: none;">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">In Detail</h3>
